...
@section('title')
    <title>Num-Alloc Edit OCN Manager Profile</title>
@stop
    ...
    <ul id="dashboard-menu">
        ...
        <li class="active">
            ...
            <ul class="active submenu">
                ...
                <li><a href="/manager/edit" class="active">Edit Profile</a></li>
            </ul>
        </li>
    </ul>
@stop
    ...
    <div id="pad-wrapper" class="new-user">
        ...
        <div class="row form-wrapper">
            ...
            <div class="col-md-6 with-sidebar">
                ...
                @endif
                {{ Form:: open(['action' => 'OCNManagerController@editProfile', 'class' => 'form-horizontal']) }}
