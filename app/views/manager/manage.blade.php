        ...
        <div class="table-wrapper users-table section">
            ...
            <div class="row filter-block">
                <div class="pull-right">
                    <a class="btn-flat pull-right success new-product add-user" href="/manager/add">+ Add Admin</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach($admins as $admin)
                            <tr class="">
                                ...
                                <td class="center align-right">{{ link_to("/manager/delete/{$admin->id}", "Delete") }}</td>
                            </tr>
                        @endforeach
                        <!-- row -->
                        <tr class="first">
