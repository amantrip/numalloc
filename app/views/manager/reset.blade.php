...
@section('title')
    <title>Num-ALLOC OCN Manager Password Reset</title>
@stop
    ...
    <ul id="dashboard-menu">
        ...
        <li class="active">
            ...
            <ul class="active submenu">
                ...
                <li><a href="/manager/manage" class="reset">Manage Admin</a></li>
    ...
    <div id="pad-wrapper" class="new-user">
        ...
        <div class="row form-wrapper">
            ...
            <div class="col-md-6 with-sidebar">
                ...
                @endif
                {{ Form:: open(['action' => 'OCNManagerController@resetPassword', 'class' => 'form-horizontal']) }}
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-8">
                            ...
                            <a class="btn btn-flat" href="/manager">Cancel</a>
                        </div>
                    </div>
            </div>
        </div>
