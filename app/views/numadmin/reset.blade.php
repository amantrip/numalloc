...
@section('title')
    <title>Num-ALLOC Number Admin Password Reset</title>
@stop
    ...
    <ul id="dashboard-menu">
        ...
        <li class="active">
            ...
            <ul class="active submenu">
                ...
                <li><a href="/numadmin/reset" class="active">Reset Password</a></li>
    ...
    <div id="pad-wrapper" class="new-user">
        ...
        <div class="row form-wrapper">
            ...
            <div class="col-md-6 with-sidebar">
                ...
                @endif
                {{ Form:: open(['action' => 'NumberAdminController@resetPassword', 'class' => 'form-horizontal']) }}
