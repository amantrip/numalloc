...
@section('title')
    <title>Num-Alloc Add Area Code</title>
@stop
    ...
    <div id="pad-wrapper" class="new-user">
        ...
        <div class="row form-wrapper">
            ...
            <div class="col-md-6 with-sidebar">
                ...
                @endif
                {{ Form:: open(['action' => 'AreaCodeController@addAreaCode', 'class' => 'form-horizontal']) }}
                    <div class="form-group">
                        {{ Form:: label('area', 'Area', ['class' => 'col-md-2 control-label']) }}
                        <div class="col-md-8">
                            {{ Form:: input('text', 'area',  null, ['class' => 'form-control', 'placeholder' => 'Area', 'required']) }}
                        </div>
                    </div>
                    <div class="form-group">
                        {{ Form:: label('code', 'Code', ['class' => 'col-md-2 control-label']) }}
                        <div class="col-md-8">
                            {{ Form:: input('number', 'code',  null, ['class' => 'form-control', 'placeholder' => 'Code',  'required']) }}
                        </div>
                    </div>
